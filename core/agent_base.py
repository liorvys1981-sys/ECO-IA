...
class AgentBase(ABC):
    def __init__(self, name, description, message_bus: MessageBus | None = None, config=None):
        self.name = name
    ...
    async def on_start(self):
        """Hook executed when the agent starts."""

    @abstractmethod
    async def on_stop(self):
        """Hook executed when the agent stops."""
    ...
    async def on_message(self, message: Message):
        """Hook executed for received messages."""
