...
class AutoScaler:
    ...
    def evaluate_and_scale(
            self, service: str, cpu_percent: float) -> dict[str, Any]:
    ...
    def scale(self, service: str, replicas: int,
        ...
        if success:
            self._current_replicas[service] = replicas
        event = {
            "service": service,
    ...
    def get_scale_history(
        self, limit: int = 20): return self._scale_events[-limit:]
