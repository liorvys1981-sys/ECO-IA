"""ECO-IA global settings loaded from environment variables."""
...
# Hetzner
# ------------------------------------------------------------------
HETZNER_STORAGE_BOX_HOST: str = os.getenv("HETZNER_STORAGE_BOX_HOST", "")
HETZNER_STORAGE_BOX_USER: str = os.getenv("HETZNER_STORAGE_BOX_USER", "")
